...
let inputChecked = document.querySelectorAll('.scale-inputs input[name="amount-of-money"]')
...
paymentAmountInput.forEach(input => input.addEventListener('click', highlightInput))
inputScale.addEventListener('focusout', changeInputAmount)
